...
echo '
    <table cellspacing="50" width="100%" align="center">
       <tr> 
        <th style="color:black; font-size:22;font-style:italic;">QUESTION</th>
        <th style="color:black;  font-size:22; font-style:italic;">ANSWER</th>
        <th style="color:black;  font-size:22; font-style:italic;">DATE</th>
        </tr>
        ';
        
         $q=mysqli_query($conn," SELECT  `questionn`, `answer`,  `date` FROM `question` where gang='news'" );
